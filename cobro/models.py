...
from reservacion.models import TbDreservacion
...
class TbDimportacion(models.Model):
    ...
    id_estado_importacion = models.ForeignKey(TbNestadoImportacion, models.DO_NOTHING, db_column='id_estado_importacion', blank=True, null=True)
    id_usuario_registro = models.ForeignKey(TbUser, models.DO_NOTHING, db_column='id_usuario_registro', blank=True, null=True,related_name='id_usuario_registro_importacion')
    id_usuario_modificacion = models.ForeignKey(TbUser, models.DO_NOTHING, db_column='id_usuario_modificacion', blank=True, null=True,related_name='id_usuario_modificacion_importacion')
...
class TbDimportaciones(models.Model):
    ...
    id_usuario_registro = models.ForeignKey(TbUser, models.DO_NOTHING, db_column='id_usuario_registro', blank=True, null=True,related_name='id_usuario_registro_importaciones')
...
class TbDimportacionRegistro(models.Model):
    ...
    id_persona = models.CharField(max_length=255) # Por que no tiene relacion con la tabla persona en la base de datos 
    id_importacion = models.ForeignKey(TbDimportaciones, models.DO_NOTHING, db_column='id_importacion')
    importe_reservaciones = models.FloatField(blank=True, null=True)
    id_familiar = models.TextField(blank=True, null=True)  # This field type is a guess. revisar aqui tambien 
...
class TbDpersonaRegla(models.Model):
    ...
    activo = models.BooleanField()
    reglas = models.TextField(blank=True, null=True)  # This field type is a guess.
...
class TbDreglaCobro(models.Model):
    ...
    id_usuario_registro = models.ForeignKey(TbUser, models.DO_NOTHING, db_column='id_usuario_registro', blank=True, null=True,related_name='id_usuario_registro_reglaCobro')
    activo = models.BooleanField()
    fijo = models.BooleanField()
    fecha_registro = models.DateField(blank=True, null=True)
    eventos_afectados = models.TextField(blank=True, null=True)  # This field type is a guess.
    dias_afectados = models.TextField(blank=True, null=True)  # This field type is a guess.
    id_tipo_regla = models.ForeignKey(TbTipoRegla, models.DO_NOTHING, db_column='id_tipo_regla', blank=True, null=True)
...
class TbRimportacionReservacion(models.Model):
    ...
    id_importacion = models.ForeignKey(TbDimportacion, models.DO_NOTHING, db_column='id_importacion', blank=True, null=True)
...
class TbRpersonaExcluidaCobro(models.Model):
    ...
    id_importacion = models.ForeignKey(TbDimportacion, models.DO_NOTHING, db_column='id_importacion', blank=True, null=True)
    fecha_registro = models.DateField(blank=True, null=True)
    id_usuario_registro = models.ForeignKey(TbUser, models.DO_NOTHING, db_column='id_usuario_registro', blank=True, null=True,related_name='id_usuario_registro_personaExcluidaCobro')
